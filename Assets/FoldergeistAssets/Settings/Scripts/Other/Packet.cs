...
namespace FoldergeistAssets
{
    namespace SettingsManagement
    {
        public sealed class Packet : IDisposable
        {
            ...
            {
                return new SimpleResolution() { _Width = ReadFloat(moveReadPos), _Height = ReadFloat(moveReadPos) };
            }
            ...
            public void Write(SettingsData settingsData)
            {
                ...
                Write((int)settingsData._QualitySettings.Value);
            ...
            public SettingsData ReadSettingsData(bool moveReadPos = true)
            {
                ...
                data._QualitySettings.Value = (QualitySettingValues)ReadInt(moveReadPos);
